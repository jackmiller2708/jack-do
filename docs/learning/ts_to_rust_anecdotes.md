...
- I spent a lot of time "borrowing" everything by default. But then I hit cases where I wanted the function to just _take_ the data and be done with it.
...
- In TS, "If it compiles, it _might_ run."
